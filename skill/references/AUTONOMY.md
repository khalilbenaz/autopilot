...
| « Cette demande arrivée en cours de run n'est couverte par aucune tâche du plan, je devrais m'arrêter — cas 4, demande trop vague. » | S'arrêter en `bloque`. | Ce n'est pas le cas 4 tant que la demande elle-même est claire : une portée non couverte par le plan courant ouvre un nouveau cycle de conception (`SKILL.md`, section 9), ce n'est pas un arrêt. Le cas 4 ne vise que l'absence d'information suffisante pour trancher, jamais le simple fait qu'une demande arrive après ou en dehors du plan en cours. |
